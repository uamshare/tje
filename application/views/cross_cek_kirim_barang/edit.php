...
<script type="text/javascript" charset="utf-8">
    $(document).ready(function() {
		...
		var childcheck = (data[i].stat == '2') ? 'checked' : '' ;
                var childread;
                if(data[i].stat == '3'){
                ...
                $('<tr class="dimrow">'
                    ...
                    +'<td><input type="checkbox" '+ childread + ' class="span12 child-check" '+childcheck+' name="stat[]" value="' + data[i].id + '" onclick="clickcek()" /></td>'
                    +'</tr>').appendTo(addDiv);
...
//                    }      
//                });
//                getdetailkirim(item,BASEURL + "crosscek_kirim_barang/get_detail_kirim");
//                return item;
//            }
//        });
