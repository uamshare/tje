...
<table  cellpadding="0" cellspacing="0" border="0" id="t_form">
	...
	<tr>
		<td>NO. MUAT</td>
		<td><input type="text" id="no_muat" name="no_muat"  value="<?php echo isset($rows[0]['NOMOR'])?$rows[0]['NOMOR']:null;?>"></td>
		<td>NO. TERIMA</td>
		<td><input type="text" id="no_terima" name="no_terima" autocomplete="off" value="<?php echo isset($rows[0]['noterima'])?$rows[0]['noterima']:null;?>" readonly="true"></td>
	</tr>
	<tr>
		<td>TANGGAL</td>
